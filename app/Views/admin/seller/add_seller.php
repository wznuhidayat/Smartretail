    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="/main/seller/save" method="post" enctype="multipart/form-data">
              <?= csrf_field(); ?>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label>Address</label>
                  <textarea class="form-control" required="" cols="4" name="address" data-height="150" style="height: 150px;"></textarea>
                  <div class="invalid-feedback">
